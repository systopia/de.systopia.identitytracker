...
// Make CRM_Identitytracker_ExtensionUtil available.
require_once __DIR__ . '/../../identitytracker.civix.php';

// phpcs:disable PSR1.Files.SideEffects

// Add test classes to class loader.
addExtensionDirToClassLoader(__DIR__);
addExtensionToClassLoader('de.systopia.identitytracker');
 ...
 */
function _identitytracker_test_civicrm_container(ContainerBuilder $container): void {
}
